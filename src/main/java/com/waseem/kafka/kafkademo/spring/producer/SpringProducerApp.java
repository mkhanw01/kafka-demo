package com.waseem.kafka.kafkademo.spring.producer;
...
/**
 * @author waseem.kh since 19/02/24
 */
@EnableKafka
    ...
    public static class ProducerApp {
        ...
        public void run(String topicName) {
            Observable.interval(1, TimeUnit.SECONDS)
                    ...
                    .subscribe(result -> log.info("Success send message to partition {}", result.getRecordMetadata().partition()));
        }

        public Observable<SendResult<String, String>> send(String topicName, String value) {
            return Observable.from(kafkaTemplate.send(topicName, value, value));
        }
